...
import {ChallengeTypes, QuizStatuses} from "@/const";
    ...
    return (
        <button
            className={cn(
                ...
                selected && status === QuizStatuses.Correct && "bg-green-100 border-green-300 hover:bg-green-100",
                selected && status === QuizStatuses.Wrong && "bg-rose-100 border-rose-300 hover:bg-rose-100",
        ...
        >
            ...
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    selected && status === QuizStatuses.Correct && "text-green-500 border-green-500",
                    selected && status === QuizStatuses.Wrong && "text-rose-500 border-rose-500",
                )}>
                    {shortcut}
                </div>
            </div>
